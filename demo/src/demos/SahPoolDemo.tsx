...
export default function SahPoolDemo() {
  ...
  onMount(() => {
    worker = new Worker(
      new URL('../workers/sahpool.worker.ts', import.meta.url),
      { type: 'module' },
    );
    ...
    worker.onmessage = (e) => {
      ...
      switch (msg.type) {
        ...
        case 'result':
          setResults((prev) => [
            ...prev,
            { columns: msg.columns, values: msg.values },
          ]);
          break;
        case 'exec-done':
    ...
    <div class="demo-content">
      <div class="left-panel">
        <div class="toolbar">
          ...
          <span class="mode-badge" style="background: #8e44ad">
            SAH Pool
          </span>
