...
/**
   ...
   ./c-pp-lite -o ./bld/pre-js.esm64.js -Dtarget:es6-module -Dbits64 -DModule.instantiateWasm api/pre-js.c-pp.js
*/
(function(Module){
  const sIMS =
...
// end include: ./bld/pre-js.esm64.js
...
function writeStackCookie() {
  ...
  // ever overwritten.
  HEAPU32[((max)/4)] = 0x02135467;checkInt32(0x02135467);
  HEAPU32[(((max)+(4))/4)] = 0x89BACDFE;checkInt32(0x89BACDFE);
  // Also test the global address 0 for integrity.
  HEAPU32[((0)/4)] = 1668509029;checkInt32(1668509029);
}
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('sqlite3-64bit.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('sqlite3-64bit.wasm', import.meta.url).href;
...
// Begin JS library code
  ...
  function setValue(ptr, value, type = 'i8') {
    ...
    switch (type) {
      ...
      case 'i16': HEAP16[((ptr)/2)] = value;checkInt16(value); break;
      case 'i32': HEAP32[((ptr)/4)] = value;checkInt32(value); break;
      case 'i64': HEAP64[((ptr)/8)] = BigInt(value);checkInt64(value); break;
  ...
  writeStat(buf, stat) {
        HEAPU32[((buf)/4)] = stat.dev;checkInt32(stat.dev);
        HEAPU32[(((buf)+(4))/4)] = stat.mode;checkInt32(stat.mode);
        HEAPU64[(((buf)+(8))/8)] = BigInt(stat.nlink);checkInt64(stat.nlink);
        HEAPU32[(((buf)+(16))/4)] = stat.uid;checkInt32(stat.uid);
        HEAPU32[(((buf)+(20))/4)] = stat.gid;checkInt32(stat.gid);
        HEAPU32[(((buf)+(24))/4)] = stat.rdev;checkInt32(stat.rdev);
        HEAP64[(((buf)+(32))/8)] = BigInt(stat.size);checkInt64(stat.size);
        HEAP32[(((buf)+(40))/4)] = 4096;checkInt32(4096);
        HEAP32[(((buf)+(44))/4)] = stat.blocks;checkInt32(stat.blocks);
        var atime = stat.atime.getTime();
        var mtime = stat.mtime.getTime();
        var ctime = stat.ctime.getTime();
        HEAP64[(((buf)+(48))/8)] = BigInt(Math.floor(atime / 1000));checkInt64(Math.floor(atime / 1000));
        HEAPU64[(((buf)+(56))/8)] = BigInt((atime % 1000) * 1000 * 1000);checkInt64((atime % 1000) * 1000 * 1000);
        HEAP64[(((buf)+(64))/8)] = BigInt(Math.floor(mtime / 1000));checkInt64(Math.floor(mtime / 1000));
        HEAPU64[(((buf)+(72))/8)] = BigInt((mtime % 1000) * 1000 * 1000);checkInt64((mtime % 1000) * 1000 * 1000);
        HEAP64[(((buf)+(80))/8)] = BigInt(Math.floor(ctime / 1000));checkInt64(Math.floor(ctime / 1000));
        HEAPU64[(((buf)+(88))/8)] = BigInt((ctime % 1000) * 1000 * 1000);checkInt64((ctime % 1000) * 1000 * 1000);
        HEAP64[(((buf)+(96))/8)] = BigInt(stat.ino);checkInt64(stat.ino);
        return 0;
      },
  writeStatFs(buf, stats) {
        HEAPU32[(((buf)+(8))/4)] = stats.bsize;checkInt32(stats.bsize);
        HEAPU32[(((buf)+(72))/4)] = stats.bsize;checkInt32(stats.bsize);
        HEAP64[(((buf)+(16))/8)] = BigInt(stats.blocks);checkInt64(stats.blocks);
        HEAP64[(((buf)+(24))/8)] = BigInt(stats.bfree);checkInt64(stats.bfree);
        HEAP64[(((buf)+(32))/8)] = BigInt(stats.bavail);checkInt64(stats.bavail);
        HEAP64[(((buf)+(40))/8)] = BigInt(stats.files);checkInt64(stats.files);
        HEAP64[(((buf)+(48))/8)] = BigInt(stats.ffree);checkInt64(stats.ffree);
        HEAPU32[(((buf)+(56))/4)] = stats.fsid;checkInt32(stats.fsid);
        HEAPU32[(((buf)+(80))/4)] = stats.flags;checkInt32(stats.flags);  // ST_NOSUID
        HEAPU32[(((buf)+(64))/4)] = stats.namelen;checkInt32(stats.namelen);
      },
  ...
  try {
      ...
      switch (cmd) {
        ...
        case 5: {
          ...
          HEAP16[(((arg)+(offset))/2)] = 2;checkInt16(2);
          return 0;
        }
        case 6:
        case 7:
      ...
      switch (op) {
        ...
        case 21505: {
          ...
          if (stream.tty.ops.ioctl_tcgets) {
            ...
            HEAP32[((argp)/4)] = termios.c_iflag || 0;checkInt32(termios.c_iflag || 0);
            HEAP32[(((argp)+(4))/4)] = termios.c_oflag || 0;checkInt32(termios.c_oflag || 0);
            HEAP32[(((argp)+(8))/4)] = termios.c_cflag || 0;checkInt32(termios.c_cflag || 0);
            HEAP32[(((argp)+(12))/4)] = termios.c_lflag || 0;checkInt32(termios.c_lflag || 0);
            for (var i = 0; i < 32; i++) {
        ...
        case 21523: {
          ...
          if (stream.tty.ops.ioctl_tiocgwinsz) {
            ...
            var argp = syscallGetVarargP();
            HEAP16[((argp)/2)] = winsize[0];checkInt16(winsize[0]);
            HEAP16[(((argp)+(2))/2)] = winsize[1];checkInt16(winsize[1]);
          }
          return 0;
        }
        case 21524: {
  ...
  function __localtime_js(time, tmPtr) {
    ...
    tmPtr = bigintToI53Checked(tmPtr);
      ...
      HEAP32[((tmPtr)/4)] = date.getSeconds();checkInt32(date.getSeconds());
      HEAP32[(((tmPtr)+(4))/4)] = date.getMinutes();checkInt32(date.getMinutes());
      HEAP32[(((tmPtr)+(8))/4)] = date.getHours();checkInt32(date.getHours());
      HEAP32[(((tmPtr)+(12))/4)] = date.getDate();checkInt32(date.getDate());
      HEAP32[(((tmPtr)+(16))/4)] = date.getMonth();checkInt32(date.getMonth());
      HEAP32[(((tmPtr)+(20))/4)] = date.getFullYear()-1900;checkInt32(date.getFullYear()-1900);
      HEAP32[(((tmPtr)+(24))/4)] = date.getDay();checkInt32(date.getDay());
  
      var yday = ydayFromDate(date)|0;
      HEAP32[(((tmPtr)+(28))/4)] = yday;checkInt32(yday);
      HEAP64[(((tmPtr)+(40))/8)] = BigInt(-(date.getTimezoneOffset() * 60));checkInt64(-(date.getTimezoneOffset() * 60));
      ...
      HEAP32[(((tmPtr)+(32))/4)] = dst;checkInt32(dst);
    ;
  }
  ...
  try {
      ...
      var ptr = res.ptr;
      HEAP32[((allocated)/4)] = res.allocated;checkInt32(res.allocated);
  ...
  var __tzset_js = function(timezone, daylight, std_name, dst_name) {
    ...
    dst_name = bigintToI53Checked(dst_name);
      ...
      HEAP32[((daylight)/4)] = Number(winterOffset != summerOffset);checkInt32(Number(winterOffset != summerOffset));
  ...
  function _clock_time_get(clk_id, ignored_precision, ptime) {
    ...
    ptime = bigintToI53Checked(ptime);
      ...
      HEAP64[((ptime)/8)] = BigInt(nsec);checkInt64(nsec);
      return 0;
    ;
  }
  ...
  function _environ_sizes_get(penviron_count, penviron_buf_size) {
    ...
    penviron_buf_size = bigintToI53Checked(penviron_buf_size);
      ...
      HEAPU64[((penviron_count)/8)] = BigInt(strings.length);checkInt64(strings.length);
      var bufSize = 0;
      for (var string of strings) {
        bufSize += lengthBytesUTF8(string) + 1;
      }
      HEAPU64[((penviron_buf_size)/8)] = BigInt(bufSize);checkInt64(bufSize);
      return 0;
    ;
  }
  ...
  try {
      ...
      HEAP16[(((pbuf)+(2))/2)] = flags;checkInt16(flags);
      HEAP64[(((pbuf)+(8))/8)] = BigInt(rightsBase);checkInt64(rightsBase);
      HEAP64[(((pbuf)+(16))/8)] = BigInt(rightsInheriting);checkInt64(rightsInheriting);
      return 0;
    } catch (e) {
    if (typeof FS == 'undefined' || !(e.name === 'ErrnoError')) throw e;
    return e.errno;
  ...
  try {
      ...
      HEAPU64[((pnum)/8)] = BigInt(num);checkInt64(num);
      return 0;
    } catch (e) {
    if (typeof FS == 'undefined' || !(e.name === 'ErrnoError')) throw e;
    return e.errno;
  ...
  try {
      ...
      HEAP64[((newOffset)/8)] = BigInt(stream.position);checkInt64(stream.position);
...
// end include: ./bld/post-js.esm64.js
...
(function(){
  ...
  */
  const sIMS = globalThis.sqlite3InitModuleState = Object.assign(Object.create(null),{
    ...
    */
    wasmFilename: 'sqlite3-64bit.wasm' /* replaced by the build process */
  });
  sIMS.debugModule =
